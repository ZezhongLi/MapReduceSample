 ...
 * @author mac
 */
public class TwoHopConnJob {
	// The Karmasphere Studio Workflow Log displays logging from Apache Commons
	// Logging, for example:
	// private static final Log LOG =
	// LogFactory.getLog("org.sample.WordCountJob");

	public static void main(String[] args) throws Exception {
		// args = new String[2];
		// args[0] = "./data/input_hw.txt";
		// args[1] = "./data/output";
		...
		job.setJarByClass(TwoHopConnJob.class);
	...
	public static void initJob(Job job) {
		...
		// CG_MAPPER_HIDDEN
		job.setMapperClass(org.sample.TwoHopConnMapper.class);
		...
		// CG_REDUCER_HIDDEN
		job.setReducerClass(org.sample.TwoHopConnReducer.class);
